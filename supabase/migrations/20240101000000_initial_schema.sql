...
-- Function to update pending vote counts (atomic vote counting)
...
GRANT EXECUTE ON FUNCTION public.apply_score_change(TEXT, TEXT, INTEGER, TEXT, TEXT, INTEGER, TEXT, TEXT) TO service_role;
GRANT EXECUTE ON FUNCTION public.get_user_group_score(TEXT, TEXT) TO service_role;
GRANT EXECUTE ON FUNCTION public.update_pending_vote_counts() TO service_role;
...
REVOKE EXECUTE ON FUNCTION public.apply_score_change(TEXT, TEXT, INTEGER, TEXT, TEXT, INTEGER, TEXT, TEXT) FROM public;
REVOKE EXECUTE ON FUNCTION public.get_user_group_score(TEXT, TEXT) FROM public;
REVOKE EXECUTE ON FUNCTION public.update_pending_vote_counts() FROM public;
...
(9, 'Atomic updates for scores and votes')
